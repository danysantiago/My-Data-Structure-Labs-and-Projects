...
public class SellAction implements Action {
	...
	public int execute() {
		...
		if(validateInput == 1){
			try {
				System.out.println("Selling of shares was sucessful\nCapital gain was: $" + 
						DataHandler.sellShare(shareholderId, companySymbol, amountOfShares));
				...
				System.out.println("Shareholder dosen't own any share of such Company.");
			} catch (InsufficientSharesToBuyException e) {
				System.out.println("Shareholder dosen't have enough shares to sell.");
			}
			return EXECUTED;
