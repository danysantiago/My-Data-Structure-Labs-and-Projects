...
public class TestSortingQS {
	...
	public static void main(String[] args) {
		...
		System.out.println("Quicksort Tester\n "); 
		final int N = 100;
		...
		QuickSortSorter<Pair> qs = new QuickSortSorter<Pair>(new PairComparator1()); 
	    ...
	    qs = new QuickSortSorter<Pair>(new PairComparator2()); 
		qs.sort(new ArrayListPortion<Pair>(p, 0, p.size()-1)); 
